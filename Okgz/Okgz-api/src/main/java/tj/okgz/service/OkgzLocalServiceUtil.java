 ...
 * {@link tj.okgz.service.impl.OkgzLocalServiceImpl} and is the
 ...
 * @see tj.okgz.service.base.OkgzLocalServiceBaseImpl
...
public class OkgzLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.okgz.service.impl.OkgzLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<tj.okgz.model.Okgz> getOkgzs(int start, int end) {
	...
	*/
	public static tj.okgz.model.Okgz addOkgz(tj.okgz.model.Okgz okgz) {
	...
	* @return the new okgz
	*/
	public static tj.okgz.model.Okgz createOkgz(long okgz_id) {
	...
	*/
	public static tj.okgz.model.Okgz deleteOkgz(long okgz_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the okgz that was removed
	*/
	public static tj.okgz.model.Okgz deleteOkgz(tj.okgz.model.Okgz okgz) {
		return getService().deleteOkgz(okgz);
	}

	public static tj.okgz.model.Okgz fetchOkgz(long okgz_id) {
	...
	* @throws PortalException if a okgz with the primary key could not be found
	*/
	public static tj.okgz.model.Okgz getOkgz(long okgz_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static tj.okgz.model.Okgz updateOkgz(tj.okgz.model.Okgz okgz) {
