...
/**
 * The cache model class for representing spisok_lotov in entity cache.
 *
 ...
 */
@ProviderType
public class spisok_lotovCacheModel implements CacheModel<spisok_lotov>,
	Externalizable {
	@Override
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof spisok_lotovCacheModel)) {
			return false;
		}

		spisok_lotovCacheModel spisok_lotovCacheModel = (spisok_lotovCacheModel)obj;

		if (spisok_lotov_id == spisok_lotovCacheModel.spisok_lotov_id) {
			return true;
		}
	...
	@Override
	public spisok_lotov toEntityModel() {
		spisok_lotovImpl spisok_lotovImpl = new spisok_lotovImpl();

		spisok_lotovImpl.setCena_kontrakta(cena_kontrakta);

		if (cena_postavki == null) {
			spisok_lotovImpl.setCena_postavki(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setCena_postavki(cena_postavki);
		}

		if (data_izmenenija == Long.MIN_VALUE) {
			spisok_lotovImpl.setData_izmenenija(null);
		}
		else {
			spisok_lotovImpl.setData_izmenenija(new Date(data_izmenenija));
		}

		if (data_sozdanija == Long.MIN_VALUE) {
			spisok_lotovImpl.setData_sozdanija(null);
		}
		else {
			spisok_lotovImpl.setData_sozdanija(new Date(data_sozdanija));
		}

		spisok_lotovImpl.setId_jebk(id_jebk);
		spisok_lotovImpl.setIstochnik_finansirovanija_id(istochnik_finansirovanija_id);
		spisok_lotovImpl.setIzmenil(izmenil);
		spisok_lotovImpl.setIzvewenie_id(izvewenie_id);

		if (klassifikacija_po_jekb == null) {
			spisok_lotovImpl.setKlassifikacija_po_jekb(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setKlassifikacija_po_jekb(klassifikacija_po_jekb);
		}

		if (kod_jekb == null) {
			spisok_lotovImpl.setKod_jekb(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setKod_jekb(kod_jekb);
		}

		if (kod_zakazchika == null) {
			spisok_lotovImpl.setKod_zakazchika(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setKod_zakazchika(kod_zakazchika);
		}

		if (mesto_postavki == null) {
			spisok_lotovImpl.setMesto_postavki(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setMesto_postavki(mesto_postavki);
		}

		if (naimenovanie_lota == null) {
			spisok_lotovImpl.setNaimenovanie_lota(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setNaimenovanie_lota(naimenovanie_lota);
		}

		spisok_lotovImpl.setNomer_lota(nomer_lota);
		spisok_lotovImpl.setObespechenie_ispolnenija(obespechenie_ispolnenija);
		spisok_lotovImpl.setObespechenie_ispolnenija_v_procentah(obespechenie_ispolnenija_v_procentah);
		spisok_lotovImpl.setObespechenie_v_procentah(obespechenie_v_procentah);
		spisok_lotovImpl.setObespechenie_zajavki(obespechenie_zajavki);

		if (oplata == null) {
			spisok_lotovImpl.setOplata(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setOplata(oplata);
		}

		if (soputstvujuwie_uslovija == null) {
			spisok_lotovImpl.setSoputstvujuwie_uslovija(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setSoputstvujuwie_uslovija(soputstvujuwie_uslovija);
		}

		spisok_lotovImpl.setSozdal(sozdal);
		spisok_lotovImpl.setSpisok_lotov_id(spisok_lotov_id);

		if (srok_dejstvija == null) {
			spisok_lotovImpl.setSrok_dejstvija(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setSrok_dejstvija(srok_dejstvija);
		}

		if (srok_ispolnenija_zajavki == null) {
			spisok_lotovImpl.setSrok_ispolnenija_zajavki(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setSrok_ispolnenija_zajavki(srok_ispolnenija_zajavki);
		}

		if (srok_obespechenija_zajavki == null) {
			spisok_lotovImpl.setSrok_obespechenija_zajavki(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setSrok_obespechenija_zajavki(srok_obespechenija_zajavki);
		}

		if (srok_postavki == null) {
			spisok_lotovImpl.setSrok_postavki(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setSrok_postavki(srok_postavki);
		}

		if (zakazchik == null) {
			spisok_lotovImpl.setZakazchik(StringPool.BLANK);
		}
		else {
			spisok_lotovImpl.setZakazchik(zakazchik);
		}
