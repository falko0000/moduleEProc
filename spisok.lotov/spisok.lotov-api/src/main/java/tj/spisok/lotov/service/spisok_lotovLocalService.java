...
/**
 * Provides the local service interface for spisok_lotov. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see spisok_lotovLocalServiceUtil
...
public interface spisok_lotovLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link spisok_lotovLocalServiceUtil} to access the spisok_lotov local service. Add custom service methods to {@link tj.spisok.lotov.service.impl.spisok_lotovLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
