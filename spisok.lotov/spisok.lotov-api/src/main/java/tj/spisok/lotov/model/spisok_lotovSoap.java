...
/**
 * This class is used by SOAP remote services, specifically {@link tj.spisok.lotov.service.http.spisok_lotovServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see tj.spisok.lotov.service.http.spisok_lotovServiceSoap
 * @generated
 */
@ProviderType
public class spisok_lotovSoap implements Serializable {
	public static spisok_lotovSoap toSoapModel(spisok_lotov model) {
		spisok_lotovSoap soapModel = new spisok_lotovSoap();
	...
	public static spisok_lotovSoap[] toSoapModels(spisok_lotov[] models) {
		spisok_lotovSoap[] soapModels = new spisok_lotovSoap[models.length];
	...
	public static spisok_lotovSoap[][] toSoapModels(spisok_lotov[][] models) {
		spisok_lotovSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new spisok_lotovSoap[models.length][models[0].length];
		}
		else {
			soapModels = new spisok_lotovSoap[0][0];
		}
	...
	public static spisok_lotovSoap[] toSoapModels(List<spisok_lotov> models) {
		List<spisok_lotovSoap> soapModels = new ArrayList<spisok_lotovSoap>(models.size());

		for (spisok_lotov model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new spisok_lotovSoap[soapModels.size()]);
	}

	public spisok_lotovSoap() {
	}
