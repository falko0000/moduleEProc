...
/**
 * Provides the remote service interface for VBK. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=sappservices", "json.web.service.context.path=VBK"}, service = VBKService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface VBKService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
