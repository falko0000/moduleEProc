...
/**
 * Provides the local service interface for SupplirCriteria. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SupplirCriteriaLocalServiceUtil
...
public interface SupplirCriteriaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SupplirCriteriaLocalServiceUtil} to access the supplir criteria local service. Add custom service methods to {@link tj.supplier.criteria.service.impl.SupplirCriteriaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SupplirCriteria getSupplierCriteria(long criteria_id,
