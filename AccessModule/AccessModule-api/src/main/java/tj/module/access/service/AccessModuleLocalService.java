...
/**
 * Provides the local service interface for AccessModule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccessModuleLocalServiceUtil
...
public interface AccessModuleLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccessModuleLocalServiceUtil} to access the access module local service. Add custom service methods to {@link tj.module.access.service.impl.AccessModuleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AccessModule deleteAccessModule(long dostup_id)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccessModule getAccessModule(long dostup_id)
		throws PortalException;
