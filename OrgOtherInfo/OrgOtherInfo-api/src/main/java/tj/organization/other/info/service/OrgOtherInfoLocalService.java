...
/**
 * Provides the local service interface for OrgOtherInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OrgOtherInfoLocalServiceUtil
...
public interface OrgOtherInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrgOtherInfoLocalServiceUtil} to access the org other info local service. Add custom service methods to {@link tj.organization.other.info.service.impl.OrgOtherInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrgOtherInfo> getOrgOtherInfos(int start, int end);
	...
	*/
	...
	public OrgOtherInfo addOrgOtherInfo(OrgOtherInfo orgOtherInfo);
	...
	*/
	public OrgOtherInfo createOrgOtherInfo(long organization_id);
	...
	*/
	...
	public OrgOtherInfo deleteOrgOtherInfo(long organization_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OrgOtherInfo deleteOrgOtherInfo(OrgOtherInfo orgOtherInfo);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrgOtherInfo fetchOrgOtherInfo(long organization_id);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrgOtherInfo getOrgOtherInfo(java.lang.String inn)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrgOtherInfo getOrgOtherInfo(long organization_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OrgOtherInfo updateOrgOtherInfo(OrgOtherInfo orgOtherInfo);
}