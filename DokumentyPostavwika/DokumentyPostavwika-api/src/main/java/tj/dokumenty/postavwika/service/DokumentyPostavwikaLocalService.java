...
/**
 * Provides the local service interface for DokumentyPostavwika. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DokumentyPostavwikaLocalServiceUtil
...
public interface DokumentyPostavwikaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DokumentyPostavwikaLocalServiceUtil} to access the dokumenty postavwika local service. Add custom service methods to {@link tj.dokumenty.postavwika.service.impl.DokumentyPostavwikaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DokumentyPostavwika> getDokumentyPostavwikas(int start, int end);
	...
	*/
	...
	public DokumentyPostavwika addDokumentyPostavwika(
	...
	*/
	public DokumentyPostavwika createDokumentyPostavwika(
	...
	*/
	...
	public DokumentyPostavwika deleteDokumentyPostavwika(
	...
	*/
	...
	public DokumentyPostavwika dokumentyPostavwika(long postavwik_id)
		throws NoSuchDokumentyPostavwikaException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DokumentyPostavwika fetchDokumentyPostavwika(
		long dokumenty_postavwika_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DokumentyPostavwika getDokumentyPostavwika(
		long dokumenty_postavwika_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public DokumentyPostavwika updateDokumentyPostavwika(
		DokumentyPostavwika dokumentyPostavwika);
}