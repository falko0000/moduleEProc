...
/**
 * The persistence interface for the istochnik finansirovanija service.
 *
 * <p>
 ...
 * @see IstochnikFinansirovanijaUtil
 * @generated
 */
@ProviderType
public interface IstochnikFinansirovanijaPersistence extends BasePersistence<IstochnikFinansirovanija> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IstochnikFinansirovanijaUtil} to access the istochnik finansirovanija persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<IstochnikFinansirovanija> istochnikFinansirovanijas);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, IstochnikFinansirovanija> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<IstochnikFinansirovanija> findAll();
	...
	*/
	public java.util.List<IstochnikFinansirovanija> findAll(int start, int end);
	...
	*/
	public java.util.List<IstochnikFinansirovanija> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IstochnikFinansirovanija> orderByComparator);
