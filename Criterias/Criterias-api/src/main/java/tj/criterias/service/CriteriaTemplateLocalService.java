...
/**
 * Provides the local service interface for CriteriaTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CriteriaTemplateLocalServiceUtil
...
public interface CriteriaTemplateLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CriteriaTemplateLocalServiceUtil} to access the criteria template local service. Add custom service methods to {@link tj.criterias.service.impl.CriteriaTemplateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
