...
/**
 * Provides the local service utility for CriteriaDefaultValue. This utility wraps
 * {@link tj.criterias.service.impl.CriteriaDefaultValueLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class CriteriaDefaultValueLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.criterias.service.impl.CriteriaDefaultValueLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getCriteriaDefaultValuesCount() {
		return getService().getCriteriaDefaultValuesCount();
	}
	...
	*/
	...
	public static java.util.List<tj.criterias.model.CriteriaDefaultValue> getCriteriaDefaultValues(
		int criteria_type_id) {
		return getService().getCriteriaDefaultValues(criteria_type_id);
	}
	...
	*/
	public static java.util.List<tj.criterias.model.CriteriaDefaultValue> getCriteriaDefaultValues(
		int start, int end) {
		return getService().getCriteriaDefaultValues(start, end);
	}
	...
	*/
	public static tj.criterias.model.CriteriaDefaultValue addCriteriaDefaultValue(
		tj.criterias.model.CriteriaDefaultValue criteriaDefaultValue) {
		return getService().addCriteriaDefaultValue(criteriaDefaultValue);
	}
	...
	*/
	public static tj.criterias.model.CriteriaDefaultValue createCriteriaDefaultValue(
		long criteria_default_value_id) {
		return getService().createCriteriaDefaultValue(criteria_default_value_id);
	}
	...
	*/
	public static tj.criterias.model.CriteriaDefaultValue deleteCriteriaDefaultValue(
		long criteria_default_value_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteCriteriaDefaultValue(criteria_default_value_id);
	}
	...
	*/
	public static tj.criterias.model.CriteriaDefaultValue deleteCriteriaDefaultValue(
		tj.criterias.model.CriteriaDefaultValue criteriaDefaultValue) {
		return getService().deleteCriteriaDefaultValue(criteriaDefaultValue);
	}

	public static tj.criterias.model.CriteriaDefaultValue fetchCriteriaDefaultValue(
		long criteria_default_value_id) {
		return getService().fetchCriteriaDefaultValue(criteria_default_value_id);
	}
	...
	* @throws PortalException if a criteria default value with the primary key could not be found
	*/
	public static tj.criterias.model.CriteriaDefaultValue getCriteriaDefaultValue(
		long criteria_default_value_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCriteriaDefaultValue(criteria_default_value_id);
	}
	...
	*/
	public static tj.criterias.model.CriteriaDefaultValue updateCriteriaDefaultValue(
		tj.criterias.model.CriteriaDefaultValue criteriaDefaultValue) {
		return getService().updateCriteriaDefaultValue(criteriaDefaultValue);
	}

	public static CriteriaDefaultValueLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CriteriaDefaultValueLocalService, CriteriaDefaultValueLocalService> _serviceTracker =
		ServiceTrackerFactory.open(CriteriaDefaultValueLocalService.class);
}