...
/**
 * Provides the local service interface for Criteria. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CriteriaLocalServiceUtil
...
public interface CriteriaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CriteriaLocalServiceUtil} to access the criteria local service. Add custom service methods to {@link tj.criterias.service.impl.CriteriaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
