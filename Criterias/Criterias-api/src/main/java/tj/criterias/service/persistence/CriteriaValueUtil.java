...
public class CriteriaValueUtil {
	...
	* @return the matching criteria values
	*/
	public static List<CriteriaValue> findByCriteriaId(long criteria_id) {
		return getPersistence().findByCriteriaId(criteria_id);
	}
	...
	*/
	public static List<CriteriaValue> findByCriteriaId(long criteria_id,
		int start, int end) {
		return getPersistence().findByCriteriaId(criteria_id, start, end);
	}
	...
	*/
	public static List<CriteriaValue> findByCriteriaId(long criteria_id,
		int start, int end, OrderByComparator<CriteriaValue> orderByComparator) {
		return getPersistence()
				   .findByCriteriaId(criteria_id, start, end, orderByComparator);
	}
	...
	*/
	public static List<CriteriaValue> findByCriteriaId(long criteria_id,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByCriteriaId(criteria_id, start, end,
			orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchCriteriaValueException if a matching criteria value could not be found
	*/
	public static CriteriaValue findByCriteriaId_First(long criteria_id,
		OrderByComparator<CriteriaValue> orderByComparator)
		throws tj.criterias.exception.NoSuchCriteriaValueException {
		return getPersistence()
				   .findByCriteriaId_First(criteria_id, orderByComparator);
	}
	...
	* @return the first matching criteria value, or <code>null</code> if a matching criteria value could not be found
	*/
	public static CriteriaValue fetchByCriteriaId_First(long criteria_id,
		OrderByComparator<CriteriaValue> orderByComparator) {
		return getPersistence()
				   .fetchByCriteriaId_First(criteria_id, orderByComparator);
	}
	...
	* @throws NoSuchCriteriaValueException if a matching criteria value could not be found
	*/
	public static CriteriaValue findByCriteriaId_Last(long criteria_id,
		OrderByComparator<CriteriaValue> orderByComparator)
		throws tj.criterias.exception.NoSuchCriteriaValueException {
		return getPersistence()
				   .findByCriteriaId_Last(criteria_id, orderByComparator);
	}
	...
	* @return the last matching criteria value, or <code>null</code> if a matching criteria value could not be found
	*/
	public static CriteriaValue fetchByCriteriaId_Last(long criteria_id,
		OrderByComparator<CriteriaValue> orderByComparator) {
		return getPersistence()
				   .fetchByCriteriaId_Last(criteria_id, orderByComparator);
	}
	...
	* @throws NoSuchCriteriaValueException if a criteria value with the primary key could not be found
	*/
	public static CriteriaValue[] findByCriteriaId_PrevAndNext(
		long criteria_value_id, long criteria_id,
		OrderByComparator<CriteriaValue> orderByComparator)
		throws tj.criterias.exception.NoSuchCriteriaValueException {
		return getPersistence()
				   .findByCriteriaId_PrevAndNext(criteria_value_id,
			criteria_id, orderByComparator);
	}
	...
	* @param criteria_id the criteria_id
	*/
	public static void removeByCriteriaId(long criteria_id) {
		getPersistence().removeByCriteriaId(criteria_id);
	}
	...
	* @return the number of matching criteria values
	*/
	public static int countByCriteriaId(long criteria_id) {
		return getPersistence().countByCriteriaId(criteria_id);
	}
