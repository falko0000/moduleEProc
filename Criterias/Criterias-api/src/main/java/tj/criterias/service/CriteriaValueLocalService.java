...
/**
 * Provides the local service interface for CriteriaValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CriteriaValueLocalServiceUtil
...
public interface CriteriaValueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CriteriaValueLocalServiceUtil} to access the criteria value local service. Add custom service methods to {@link tj.criterias.service.impl.CriteriaValueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
