...
public class CriteriaPersistenceImpl extends BasePersistenceImpl<Criteria>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CriteriaModelImpl.ENTITY_CACHE_ENABLED,
			CriteriaModelImpl.FINDER_CACHE_ENABLED, CriteriaImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CriteriaModelImpl.ENTITY_CACHE_ENABLED,
			CriteriaModelImpl.FINDER_CACHE_ENABLED, CriteriaImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CriteriaModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CriteriaModelImpl.ENTITY_CACHE_ENABLED,
			CriteriaModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Criteria> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Criteria> findByUuid(String uuid, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Criteria criteria : list) {
					if (!Objects.equals(uuid, criteria.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public Criteria findByUuid_First(String uuid,
		OrderByComparator<Criteria> orderByComparator)
		throws NoSuchCriteriaException {
		Criteria criteria = fetchByUuid_First(uuid, orderByComparator);
	 ...
	 */
	@Override
	public Criteria fetchByUuid_First(String uuid,
		OrderByComparator<Criteria> orderByComparator) {
		List<Criteria> list = findByUuid(uuid, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Criteria findByUuid_Last(String uuid,
		OrderByComparator<Criteria> orderByComparator)
		throws NoSuchCriteriaException {
		Criteria criteria = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 */
	@Override
	public Criteria fetchByUuid_Last(String uuid,
		OrderByComparator<Criteria> orderByComparator) {
		...
		List<Criteria> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Criteria[] findByUuid_PrevAndNext(long criteria_id, String uuid,
		OrderByComparator<Criteria> orderByComparator)
		throws NoSuchCriteriaException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, criteria, uuid,
					orderByComparator, true);

			array[1] = criteria;

			array[2] = getByUuid_PrevAndNext(session, criteria, uuid,
	...
	protected Criteria getByUuid_PrevAndNext(Session session,
		Criteria criteria, String uuid,
	...
	public void removeByUuid(String uuid) {
		for (Criteria criteria : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "criteria.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "criteria.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(criteria.uuid IS NULL OR criteria.uuid = '')";
	...
	public Criteria updateImpl(Criteria criteria) {
		...
		if (Validator.isNull(criteria.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !CriteriaModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((criteriaModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { criteriaModelImpl.getOriginalUuid() };

				finderCache.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
					args);

				args = new Object[] { criteriaModelImpl.getUuid() };
	...
	protected Criteria toUnwrappedModel(Criteria criteria) {
		...
		criteriaImpl.setUuid(criteria.getUuid());
