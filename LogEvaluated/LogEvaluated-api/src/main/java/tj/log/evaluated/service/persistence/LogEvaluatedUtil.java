...
public class LogEvaluatedUtil {
	...
	* @return the matching log evaluateds
	*/
	public static List<LogEvaluated> findBySpIdOrgId(long spisok_lotov_id,
		long organization_id) {
		return getPersistence().findBySpIdOrgId(spisok_lotov_id, organization_id);
	}
	...
	*/
	public static List<LogEvaluated> findBySpIdOrgId(long spisok_lotov_id,
		...
		return getPersistence()
				   .findBySpIdOrgId(spisok_lotov_id, organization_id, start, end);
	}
	...
	*/
	public static List<LogEvaluated> findBySpIdOrgId(long spisok_lotov_id,
		...
		OrderByComparator<LogEvaluated> orderByComparator) {
		return getPersistence()
				   .findBySpIdOrgId(spisok_lotov_id, organization_id, start,
	...
	* @throws NoSuchLogEvaluatedException if a matching log evaluated could not be found
	*/
	public static LogEvaluated findBySpIdOrgId_First(long spisok_lotov_id,
		long organization_id, OrderByComparator<LogEvaluated> orderByComparator)
		throws tj.log.evaluated.exception.NoSuchLogEvaluatedException {
		return getPersistence()
				   .findBySpIdOrgId_First(spisok_lotov_id, organization_id,
			orderByComparator);
	}
	...
	* @return the first matching log evaluated, or <code>null</code> if a matching log evaluated could not be found
	*/
	public static LogEvaluated fetchBySpIdOrgId_First(long spisok_lotov_id,
		long organization_id, OrderByComparator<LogEvaluated> orderByComparator) {
		return getPersistence()
				   .fetchBySpIdOrgId_First(spisok_lotov_id, organization_id,
			orderByComparator);
	}
	...
	* @throws NoSuchLogEvaluatedException if a matching log evaluated could not be found
	*/
	public static LogEvaluated findBySpIdOrgId_Last(long spisok_lotov_id,
		long organization_id, OrderByComparator<LogEvaluated> orderByComparator)
		throws tj.log.evaluated.exception.NoSuchLogEvaluatedException {
		return getPersistence()
				   .findBySpIdOrgId_Last(spisok_lotov_id, organization_id,
			orderByComparator);
	}
	...
	* @return the last matching log evaluated, or <code>null</code> if a matching log evaluated could not be found
	*/
	public static LogEvaluated fetchBySpIdOrgId_Last(long spisok_lotov_id,
		long organization_id, OrderByComparator<LogEvaluated> orderByComparator) {
		return getPersistence()
				   .fetchBySpIdOrgId_Last(spisok_lotov_id, organization_id,
			orderByComparator);
	}
	...
	* @throws NoSuchLogEvaluatedException if a log evaluated with the primary key could not be found
	*/
	public static LogEvaluated[] findBySpIdOrgId_PrevAndNext(
		long log_evaluated_id, long spisok_lotov_id, long organization_id,
		OrderByComparator<LogEvaluated> orderByComparator)
		throws tj.log.evaluated.exception.NoSuchLogEvaluatedException {
		return getPersistence()
				   .findBySpIdOrgId_PrevAndNext(log_evaluated_id,
			spisok_lotov_id, organization_id, orderByComparator);
	}
	...
	* @param organization_id the organization_id
	*/
	public static void removeBySpIdOrgId(long spisok_lotov_id,
		long organization_id) {
		getPersistence().removeBySpIdOrgId(spisok_lotov_id, organization_id);
	}
	...
	* @return the number of matching log evaluateds
	*/
	public static int countBySpIdOrgId(long spisok_lotov_id,
		long organization_id) {
		return getPersistence()
				   .countBySpIdOrgId(spisok_lotov_id, organization_id);
	}
