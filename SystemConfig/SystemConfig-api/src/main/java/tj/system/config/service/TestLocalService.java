...
public interface TestLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestLocalServiceUtil} to access the test local service. Add custom service methods to {@link tj.system.config.service.impl.TestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new test
	*/
	public Test createTest(long system_config_id_);
	...
	*/
	...
	public Test deleteTest(long system_config_id_) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Test fetchTest(long system_config_id_);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Test getTest(long system_config_id_) throws PortalException;
