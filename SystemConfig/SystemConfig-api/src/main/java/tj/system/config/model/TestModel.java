...
/**
 * The base model interface for the Test service. Represents a row in the &quot;System_config_Test&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link tj.system.config.model.impl.TestModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link tj.system.config.model.impl.TestImpl}.
 * </p>
 *
...
public interface TestModel extends BaseModel<Test> {
	...
	@Override
	public CacheModel<tj.system.config.model.Test> toCacheModel();
