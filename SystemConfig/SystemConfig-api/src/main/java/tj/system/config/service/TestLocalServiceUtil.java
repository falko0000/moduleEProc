 ...
 * {@link tj.system.config.service.impl.TestLocalServiceImpl} and is the
 ...
 * @see tj.system.config.service.base.TestLocalServiceBaseImpl
 * @see tj.system.config.service.impl.TestLocalServiceImpl
 * @generated
 */
@ProviderType
public class TestLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.system.config.service.impl.TestLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<tj.system.config.model.Test> getTests(
		int start, int end) {
	...
	*/
	public static tj.system.config.model.Test addTest(
	...
	* @return the new test
	*/
	public static tj.system.config.model.Test createTest(long system_config_id_) {
		return getService().createTest(system_config_id_);
	}
	...
	*/
	public static tj.system.config.model.Test deleteTest(long system_config_id_)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteTest(system_config_id_);
	}
	...
	* @return the test that was removed
	*/
	public static tj.system.config.model.Test deleteTest(
		tj.system.config.model.Test test) {
		return getService().deleteTest(test);
	}

	public static tj.system.config.model.Test fetchTest(long system_config_id_) {
		return getService().fetchTest(system_config_id_);
	}
	...
	* @throws PortalException if a test with the primary key could not be found
	*/
	public static tj.system.config.model.Test getTest(long system_config_id_)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getTest(system_config_id_);
	}
	...
	*/
	public static tj.system.config.model.Test updateTest(
		tj.system.config.model.Test test) {
