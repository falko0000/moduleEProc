...
/**
 * Provides the local service interface for tipy_izvewenij. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see tipy_izvewenijLocalServiceUtil
...
public interface tipy_izvewenijLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link tipy_izvewenijLocalServiceUtil} to access the tipy_izvewenij local service. Add custom service methods to {@link tj.tipy.izvewenij.service.impl.tipy_izvewenijLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
