...
/**
 * Provides the local service interface for TipyIzvewenij. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TipyIzvewenijLocalServiceUtil
...
public interface TipyIzvewenijLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipyIzvewenijLocalServiceUtil} to access the tipy izvewenij local service. Add custom service methods to {@link tj.tipy.izvewenij.service.impl.TipyIzvewenijLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
