...
import tj.spisok.lotov.model.SpisoklotovModel;
...
public class SpisoklotovModelImpl extends BaseModelImpl<Spisoklotov>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(tj.spisok.lotov.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.tj.spisok.lotov.model.Spisoklotov"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(tj.spisok.lotov.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.tj.spisok.lotov.model.Spisoklotov"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(tj.spisok.lotov.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.tj.spisok.lotov.model.Spisoklotov"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(tj.spisok.lotov.service.util.ServiceProps.get(
				"lock.expiration.time.tj.spisok.lotov.model.Spisoklotov"));
	...
	public String toXmlString() {
		...
		sb.append("tj.spisok.lotov.model.Spisoklotov");
