 ...
 * @see tj.spisok.lotov.model.impl.SpisoklotovImpl
 * @see tj.spisok.lotov.model.impl.SpisoklotovModelImpl
 * @generated
 */
@ImplementationClassName("tj.spisok.lotov.model.impl.SpisoklotovImpl")
@ProviderType
public interface Spisoklotov extends SpisoklotovModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link tj.spisok.lotov.model.impl.SpisoklotovImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
