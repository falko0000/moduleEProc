...
/**
 * Provides the local service interface for Spisoklotov. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SpisoklotovLocalServiceUtil
...
public interface SpisoklotovLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpisoklotovLocalServiceUtil} to access the spisoklotov local service. Add custom service methods to {@link tj.spisok.lotov.service.impl.SpisoklotovLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
