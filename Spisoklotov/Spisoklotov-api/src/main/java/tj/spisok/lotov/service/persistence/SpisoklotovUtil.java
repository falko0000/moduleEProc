 ...
 * @see tj.spisok.lotov.service.persistence.impl.SpisoklotovPersistenceImpl
 * @generated
 */
@ProviderType
public class SpisoklotovUtil {
	...
	*/
	public static Spisoklotov findByIzvewenieID_First(long izvewenie_id,
		OrderByComparator<Spisoklotov> orderByComparator)
		throws tj.spisok.lotov.exception.NoSuchSpisoklotovException {
		return getPersistence()
