...
public class SpisoklotovWrapper implements Spisoklotov,
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<tj.spisok.lotov.model.Spisoklotov> toCacheModel() {
	...
	*/
	...
	@Override
	public int compareTo(tj.spisok.lotov.model.Spisoklotov spisoklotov) {
	...
	*/
	...
	@Override
	public tj.spisok.lotov.model.Spisoklotov toEscapedModel() {
		return new SpisoklotovWrapper(_spisoklotov.toEscapedModel());
	}

	@Override
	public tj.spisok.lotov.model.Spisoklotov toUnescapedModel() {
