...
/**
 * Provides the local service interface for Bidqueue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BidqueueLocalServiceUtil
...
public interface BidqueueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BidqueueLocalServiceUtil} to access the bidqueue local service. Add custom service methods to {@link tj.bid.queue.service.impl.BidqueueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Bidqueue> getBidqueues(int start, int end);
	...
	*/
	...
	public Bidqueue addBidqueue(Bidqueue bidqueue);
	...
	*/
	public Bidqueue createBidqueue(long bid_queue_id);
	...
	*/
	...
	public Bidqueue deleteBidqueue(long bid_queue_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Bidqueue deleteBidqueue(Bidqueue bidqueue);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Bidqueue fetchBidqueue(long bid_queue_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Bidqueue getBidqueue(long bid_queue_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Bidqueue updateBidqueue(Bidqueue bidqueue);
}