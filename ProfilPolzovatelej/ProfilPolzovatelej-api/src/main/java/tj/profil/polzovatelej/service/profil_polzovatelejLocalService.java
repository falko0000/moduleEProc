...
/**
 * Provides the local service interface for profil_polzovatelej. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see profil_polzovatelejLocalServiceUtil
...
public interface profil_polzovatelejLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link profil_polzovatelejLocalServiceUtil} to access the profil_polzovatelej local service. Add custom service methods to {@link tj.profil.polzovatelej.service.impl.profil_polzovatelejLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
