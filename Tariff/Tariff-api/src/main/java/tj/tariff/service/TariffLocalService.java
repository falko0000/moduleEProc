...
public interface TariffLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TariffLocalServiceUtil} to access the tariff local service. Add custom service methods to {@link tj.tariff.service.impl.TariffLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Tariff getTariff(long region_id, int type_tariff)
