...
/**
 * The persistence utility for the protocol contracts service. This utility wraps {@link tj.protocol.contracts.service.persistence.impl.ProtocolContractsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class ProtocolContractsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ProtocolContracts protocolContracts) {
		getPersistence().clearCache(protocolContracts);
	}
	 ...
	 */
	public static List<ProtocolContracts> findWithDynamicQuery(
	 ...
	 */
	public static ProtocolContracts update(ProtocolContracts protocolContracts) {
		return getPersistence().update(protocolContracts);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static ProtocolContracts update(
		ProtocolContracts protocolContracts, ServiceContext serviceContext) {
		return getPersistence().update(protocolContracts, serviceContext);
	}
	...
	*/
	public static ProtocolContracts findByIzvewenieId(long izvewenie_id)
		throws tj.protocol.contracts.exception.NoSuchProtocolContractsException {
	...
	*/
	public static ProtocolContracts fetchByIzvewenieId(long izvewenie_id) {
	...
	*/
	public static ProtocolContracts removeByIzvewenieId(long izvewenie_id)
		throws tj.protocol.contracts.exception.NoSuchProtocolContractsException {
	...
	*/
	public static void cacheResult(ProtocolContracts protocolContracts) {
		getPersistence().cacheResult(protocolContracts);
	}
	...
	*/
	public static void cacheResult(List<ProtocolContracts> protocolContractses) {
		getPersistence().cacheResult(protocolContractses);
	}
	...
	*/
	public static ProtocolContracts create(long protocol_contracts_id) {
		return getPersistence().create(protocol_contracts_id);
	}
	...
	*/
	public static ProtocolContracts remove(long protocol_contracts_id)
		throws tj.protocol.contracts.exception.NoSuchProtocolContractsException {
		return getPersistence().remove(protocol_contracts_id);
	}

	public static ProtocolContracts updateImpl(
		ProtocolContracts protocolContracts) {
		return getPersistence().updateImpl(protocolContracts);
	}
	...
	* @throws NoSuchProtocolContractsException if a protocol contracts with the primary key could not be found
	*/
	public static ProtocolContracts findByPrimaryKey(long protocol_contracts_id)
		throws tj.protocol.contracts.exception.NoSuchProtocolContractsException {
		return getPersistence().findByPrimaryKey(protocol_contracts_id);
	}
	...
	*/
	public static ProtocolContracts fetchByPrimaryKey(
		long protocol_contracts_id) {
		return getPersistence().fetchByPrimaryKey(protocol_contracts_id);
	}

	public static java.util.Map<java.io.Serializable, ProtocolContracts> fetchByPrimaryKeys(
	...
	*/
	public static List<ProtocolContracts> findAll() {
	...
	*/
	public static List<ProtocolContracts> findAll(int start, int end) {
	...
	*/
	...
	public static ProtocolContractsPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ProtocolContractsPersistence, ProtocolContractsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ProtocolContractsPersistence.class);
}