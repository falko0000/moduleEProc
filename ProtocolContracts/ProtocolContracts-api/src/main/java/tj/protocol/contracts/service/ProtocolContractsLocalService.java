...
/**
 * Provides the local service interface for ProtocolContracts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProtocolContractsLocalServiceUtil
...
public interface ProtocolContractsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProtocolContractsLocalServiceUtil} to access the protocol contracts local service. Add custom service methods to {@link tj.protocol.contracts.service.impl.ProtocolContractsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
