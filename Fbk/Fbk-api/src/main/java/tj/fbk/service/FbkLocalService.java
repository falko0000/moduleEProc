...
/**
 * Provides the local service interface for Fbk. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FbkLocalServiceUtil
...
public interface FbkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FbkLocalServiceUtil} to access the fbk local service. Add custom service methods to {@link tj.fbk.service.impl.FbkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
