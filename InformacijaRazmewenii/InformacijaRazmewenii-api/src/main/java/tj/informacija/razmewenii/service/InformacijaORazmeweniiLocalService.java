...
/**
 * Provides the local service interface for InformacijaORazmewenii. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InformacijaORazmeweniiLocalServiceUtil
...
public interface InformacijaORazmeweniiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InformacijaORazmeweniiLocalServiceUtil} to access the informacija o razmewenii local service. Add custom service methods to {@link tj.informacija.razmewenii.service.impl.InformacijaORazmeweniiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
