...
/**
 * Provides the local service interface for Vbk. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VbkLocalServiceUtil
...
public interface VbkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VbkLocalServiceUtil} to access the vbk local service. Add custom service methods to {@link tj.vbk.service.impl.VbkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new vbk
	*/
	public Vbk createVbk(long vbk_id);
	...
	*/
	...
	public Vbk deleteVbk(long vbk_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Vbk fetchVbk(long vbk_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Vbk getVbk(long vbk_id) throws PortalException;
