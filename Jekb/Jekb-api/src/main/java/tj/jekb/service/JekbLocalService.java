...
/**
 * Provides the local service interface for Jekb. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author falko
 * @see JekbLocalServiceUtil
...
public interface JekbLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JekbLocalServiceUtil} to access the jekb local service. Add custom service methods to {@link tj.jekb.service.impl.JekbLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
