...
/**
 * Provides the local service interface for IzveweniePut. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IzveweniePutLocalServiceUtil
...
public interface IzveweniePutLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IzveweniePutLocalServiceUtil} to access the izvewenie put local service. Add custom service methods to {@link tj.izvewenieput.service.impl.IzveweniePutLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
