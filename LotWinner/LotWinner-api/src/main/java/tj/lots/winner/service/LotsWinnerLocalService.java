...
/**
 * Provides the local service interface for LotsWinner. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LotsWinnerLocalServiceUtil
...
public interface LotsWinnerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LotsWinnerLocalServiceUtil} to access the lots winner local service. Add custom service methods to {@link tj.lots.winner.service.impl.LotsWinnerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LotsWinner> getLotsWinners(int start, int end);
	...
	*/
	...
	public LotsWinner addLotsWinner(LotsWinner lotsWinner);
	...
	*/
	public LotsWinner createLotsWinner(long lot_winner_id);
	...
	*/
	...
	public LotsWinner deleteLotsWinner(long lot_winner_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LotsWinner deleteLotsWinner(LotsWinner lotsWinner);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LotsWinner getLotsWinner(long lot_winner_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LotsWinner updateLotsWinner(LotsWinner lotsWinner);
}