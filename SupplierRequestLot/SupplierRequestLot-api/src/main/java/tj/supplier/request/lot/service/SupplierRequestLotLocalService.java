...
/**
 * Provides the local service interface for SupplierRequestLot. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SupplierRequestLotLocalServiceUtil
...
public interface SupplierRequestLotLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SupplierRequestLotLocalServiceUtil} to access the supplier request lot local service. Add custom service methods to {@link tj.supplier.request.lot.service.impl.SupplierRequestLotLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
