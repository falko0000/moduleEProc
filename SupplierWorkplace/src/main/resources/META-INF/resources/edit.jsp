...
<%
 ...
 String tab = ParamUtil.getString(request, "edit_tab","bid_generalinfo");
  ...
  Organization authorized_body_org = OrganizationLocalServiceUtil.getOrganization(SupplierWorkplaceConstant.AUTHORIZED_BODY_ID);
  ...
  if(izvewenija != null )
	{
		...
		bidorg = OrganizationLocalServiceUtil.getOrganization(SupplierWorkplaceConstant.AUTHORIZED_BODY_ID);
