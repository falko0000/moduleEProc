...
String[] CAT_NAMES = new String[]{ "generalinfo","info_about_customer",
 ...
 renderUrl.setParameter("mvcRenderCommandName", SupplierWorkplaceConstant.RENDER_COMMAND_NAME_EDIT);
 renderUrl.setParameter("edit_tab", SupplierWorkplaceConstant.TAB_BID_LISTLOTS);
...
<aui:form action="<%=listlots%>" cssClass="container-fluid-1280" method="post" name="<%=SupplierWorkplaceConstant.FORM_LISTLOTS %>"> 
...
<aui:script use="aui-base,aui-io-request">
    A.one('#<portlet:namespace/>lot_save').on('click', function(event) {
       ...
       A.io.request(
            ...
            {
               method: 'POST',
                form: {id: '<portlet:namespace/><%=SupplierWorkplaceConstant.FORM_LISTLOTS %>'},
                on: {
                    success: function() {
