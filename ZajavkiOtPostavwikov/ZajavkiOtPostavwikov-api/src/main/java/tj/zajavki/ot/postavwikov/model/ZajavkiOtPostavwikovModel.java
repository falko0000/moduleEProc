...
/**
 * The base model interface for the ZajavkiOtPostavwikov service. Represents a row in the &quot;zajavki_ot_postavwikov_ZajavkiOtPostavwikov&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link tj.zajavki.ot.postavwikov.model.impl.ZajavkiOtPostavwikovModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link tj.zajavki.ot.postavwikov.model.impl.ZajavkiOtPostavwikovImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface ZajavkiOtPostavwikovModel extends BaseModel<ZajavkiOtPostavwikov> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a zajavki ot postavwikov model instance should use the {@link ZajavkiOtPostavwikov} interface instead.
	 */
	...
	@Override
	public CacheModel<tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov> toCacheModel();
