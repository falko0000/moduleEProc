...
/**
 * Provides the local service interface for ZajavkiOtPostavwikovTemp. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ZajavkiOtPostavwikovTempLocalServiceUtil
...
public interface ZajavkiOtPostavwikovTempLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZajavkiOtPostavwikovTempLocalServiceUtil} to access the zajavki ot postavwikov temp local service. Add custom service methods to {@link tj.zajavki.ot.postavwikov.service.impl.ZajavkiOtPostavwikovTempLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<java.lang.Long, ZajavkiOtPostavwikovTemp> getMapZajavkiOtPostavwikovs(
		long lot_id, long postavwik_id);
