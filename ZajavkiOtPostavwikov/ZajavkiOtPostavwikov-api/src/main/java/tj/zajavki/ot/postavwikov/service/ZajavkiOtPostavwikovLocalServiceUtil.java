...
/**
 * Provides the local service utility for ZajavkiOtPostavwikov. This utility wraps
 * {@link tj.zajavki.ot.postavwikov.service.impl.ZajavkiOtPostavwikovLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class ZajavkiOtPostavwikovLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.zajavki.ot.postavwikov.service.impl.ZajavkiOtPostavwikovLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getZajavkiOtPostavwikovsCount() {
		return getService().getZajavkiOtPostavwikovsCount();
	}
	...
	*/
	public static java.util.List<tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov> getZajavkiOtPostavwikovs(
		int start, int end) {
		return getService().getZajavkiOtPostavwikovs(start, end);
	}
	...
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov addZajavkiOtPostavwikov(
		tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov zajavkiOtPostavwikov) {
		return getService().addZajavkiOtPostavwikov(zajavkiOtPostavwikov);
	}
	...
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov createZajavkiOtPostavwikov(
		long zajavki_ot_postavwikov_id) {
		return getService().createZajavkiOtPostavwikov(zajavki_ot_postavwikov_id);
	}
	...
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov deleteZajavkiOtPostavwikov(
		long zajavki_ot_postavwikov_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteZajavkiOtPostavwikov(zajavki_ot_postavwikov_id);
	}
	...
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov deleteZajavkiOtPostavwikov(
		tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov zajavkiOtPostavwikov) {
		return getService().deleteZajavkiOtPostavwikov(zajavkiOtPostavwikov);
	}

	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov fetchZajavkiOtPostavwikov(
		long zajavki_ot_postavwikov_id) {
		return getService().fetchZajavkiOtPostavwikov(zajavki_ot_postavwikov_id);
	}
	...
	* @throws PortalException if a zajavki ot postavwikov with the primary key could not be found
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov getZajavkiOtPostavwikov(
		long zajavki_ot_postavwikov_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getZajavkiOtPostavwikov(zajavki_ot_postavwikov_id);
	}
	...
	*/
	public static tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov updateZajavkiOtPostavwikov(
		tj.zajavki.ot.postavwikov.model.ZajavkiOtPostavwikov zajavkiOtPostavwikov) {
		return getService().updateZajavkiOtPostavwikov(zajavkiOtPostavwikov);
	}

	public static ZajavkiOtPostavwikovLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ZajavkiOtPostavwikovLocalService, ZajavkiOtPostavwikovLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ZajavkiOtPostavwikovLocalService.class);
}