 ...
 */
@ProviderType
public class ZajavkiOtPostavwikovTempSoap implements Serializable {
	public static ZajavkiOtPostavwikovTempSoap toSoapModel(
		ZajavkiOtPostavwikovTemp model) {
		ZajavkiOtPostavwikovTempSoap soapModel = new ZajavkiOtPostavwikovTempSoap();

		soapModel.setZajavki_ot_postavwikov_temp_id(model.getZajavki_ot_postavwikov_temp_id());
	...
	public static ZajavkiOtPostavwikovTempSoap[] toSoapModels(
		ZajavkiOtPostavwikovTemp[] models) {
		ZajavkiOtPostavwikovTempSoap[] soapModels = new ZajavkiOtPostavwikovTempSoap[models.length];
	...
	public static ZajavkiOtPostavwikovTempSoap[][] toSoapModels(
		ZajavkiOtPostavwikovTemp[][] models) {
		ZajavkiOtPostavwikovTempSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ZajavkiOtPostavwikovTempSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ZajavkiOtPostavwikovTempSoap[0][0];
		}
	...
	public static ZajavkiOtPostavwikovTempSoap[] toSoapModels(
		List<ZajavkiOtPostavwikovTemp> models) {
		List<ZajavkiOtPostavwikovTempSoap> soapModels = new ArrayList<ZajavkiOtPostavwikovTempSoap>(models.size());

		for (ZajavkiOtPostavwikovTemp model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ZajavkiOtPostavwikovTempSoap[soapModels.size()]);
	}

	public ZajavkiOtPostavwikovTempSoap() {
	}

	public long getPrimaryKey() {
		return _zajavki_ot_postavwikov_temp_id;
	}

	public void setPrimaryKey(long pk) {
		setZajavki_ot_postavwikov_temp_id(pk);
	}
	...
	public void setZajavki_ot_postavwikov_temp_id(
		...
		_zajavki_ot_postavwikov_temp_id = zajavki_ot_postavwikov_temp_id;
	}
	...
	private long _zajavki_ot_postavwikov_temp_id;
