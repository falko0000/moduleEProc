...
/**
 * Provides the local service utility for PorjadokRabotyKomissii. This utility wraps
 * {@link tj.porjadok.raboty.komissii.service.impl.PorjadokRabotyKomissiiLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class PorjadokRabotyKomissiiLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.porjadok.raboty.komissii.service.impl.PorjadokRabotyKomissiiLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getPorjadokRabotyKomissiisCount() {
		return getService().getPorjadokRabotyKomissiisCount();
	}
	...
	*/
	public static java.util.List<tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii> getPorjadokRabotyKomissiis(
		int start, int end) {
		return getService().getPorjadokRabotyKomissiis(start, end);
	}
	...
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii addPorjadokRabotyKomissii(
		tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii porjadokRabotyKomissii) {
		return getService().addPorjadokRabotyKomissii(porjadokRabotyKomissii);
	}
	...
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii createPorjadokRabotyKomissii(
		long porjadok_raboty_komissii_id) {
		return getService()
				   .createPorjadokRabotyKomissii(porjadok_raboty_komissii_id);
	}
	...
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii deletePorjadokRabotyKomissii(
		long porjadok_raboty_komissii_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deletePorjadokRabotyKomissii(porjadok_raboty_komissii_id);
	}
	...
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii deletePorjadokRabotyKomissii(
		tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii porjadokRabotyKomissii) {
		return getService().deletePorjadokRabotyKomissii(porjadokRabotyKomissii);
	}

	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii fetchPorjadokRabotyKomissii(
		long porjadok_raboty_komissii_id) {
		return getService()
	...
	* @throws PortalException if a porjadok raboty komissii with the primary key could not be found
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii getPorjadokRabotyKomissii(
		long porjadok_raboty_komissii_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getPorjadokRabotyKomissii(porjadok_raboty_komissii_id);
	}
	...
	*/
	public static tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii updatePorjadokRabotyKomissii(
		tj.porjadok.raboty.komissii.model.PorjadokRabotyKomissii porjadokRabotyKomissii) {
		return getService().updatePorjadokRabotyKomissii(porjadokRabotyKomissii);
	}

	public static PorjadokRabotyKomissiiLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<PorjadokRabotyKomissiiLocalService, PorjadokRabotyKomissiiLocalService> _serviceTracker =
		ServiceTrackerFactory.open(PorjadokRabotyKomissiiLocalService.class);
}